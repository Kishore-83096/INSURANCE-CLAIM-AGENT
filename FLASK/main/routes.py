from main.services import home, health_check, upload_claim_file,list_google_drive_test_files,import_google_drive_file,extract_claim_text,extract_claim_fields_api,validate_claim_fields,route_claim_api,nvidia_ai_health_check,ai_extract_claim_fields,ai_validate_claim_fields,ai_explain_route
...
def register_routes(app):
    ...
    app.add_url_rule("/api/claims/google-drive-test-files",view_func=list_google_drive_test_files,methods=["GET"])
    app.add_url_rule("/api/claims/import-google-drive",view_func=import_google_drive_file,methods=["POST"])
